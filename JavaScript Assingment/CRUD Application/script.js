const SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJud2dnd3lycWJ5aXJweXhweWdhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTgyMjQzMzIsImV4cCI6MjA3MzgwMDMzMn0.nCg4Jc7K_as_OQ36J74IPJMGy56gDsMgCgLibIlLZoU";
...
//               const { error } = await supabase.from("todos").insert({ task: input.value, is_completed: false , })
